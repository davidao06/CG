...
void preparaCilindro(float altura, float raio, int lados) {
	...
	for (int i = 0; i < lados; ++i) {
		...
		t[vertex*2 ] = 0.1875 * cos(i*delta) + 0.4375;
		...
		t[vertex*2 ] = 0.1875 * cos((i+1) * delta) + 0.4375;
		...
		v[vertex*3 + 1] = -altura/2.0f;
		v[vertex*3 + 2] = raio * cos( (i+1) * delta);
		t[vertex*2 ] = 0.1875 * cos((i+i) * delta) + 0.8125;
		t[vertex*2 + 1] = 0.1875 + 0.1875 * sin((i+i) * delta);
		...
		v[vertex*3 + 1] = -altura/2.0f;
		v[vertex*3 + 2] = raio * cos( i * delta);
		t[vertex*2 ] = 0.1875 * cos(i * delta) + 0.8125;
		t[vertex*2 + 1] = 0.1875 + 0.1875 * sin(i * delta);
